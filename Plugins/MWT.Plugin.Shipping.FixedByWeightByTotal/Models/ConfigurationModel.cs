...
namespace MWT.Plugin.Shipping.FixedByWeightByTotal.Models
{
    ...
    {
        [NopResourceDisplayName("MWT.Plugins.Shipping.FixedByWeightByTotal.Fields.LimitMethodsToCreated")]
        ...
        [NopResourceDisplayName("MWT.Plugins.Shipping.FixedByWeightByTotal.Fields.Zip")]
