...
namespace MWT.Plugin.Shipping.FixedByWeightByTotal
{
    ...
    public static class FixedByWeightByTotalDefaults
    {
        ...
        /// </summary>
        public const string FixedRateSettingsKey = "MWT.ShippingRateComputationMethod.FixedByWeightByTotal.Rate.ShippingMethodId{0}";

        /// <summary>
        /// The key of the settings to save transit days of the shipping method
        /// </summary>
        public const string TransitDaysSettingsKey = "MWT.ShippingRateComputationMethod.FixedByWeightByTotal.TransitDays.ShippingMethodId{0}";
    }
}
