...
{
    [ViewComponent(Name = "ProductBundleWidget")]
    public class ProductBundleWidgetViewComponent : NopViewComponent
    {
        #region Fields
       ...
       NopBundleCatalogDefaults.BundleWidgetModelKey,
       productDetailsModel.Id, selectedVariantId, workingLanguage, currentStore);
                    ...
                    foreach (var bundle in validBundles)
                    {
                        ...
                        if (currentBundleItems.Count > 0)
                        {
                            ...
                            var bundlePictureCacheKey = _staticCacheManager.PrepareKeyForDefaultCache(
                                NopBundleCatalogDefaults.BundlePictureModelKey,
                ...
                return View("~/Plugins/MWT.Nop.Plugin.Misc.ProductBundle/Views/PublicInfo.cshtml", model);
            }
            catch (Exception exp)
            {
