...
namespace Nop.Plugin.ExternalAuth.Apple.Infrastructure
{
    ...
    /// </summary>
    public partial class AppleAuthenticationEventConsumer : IConsumer<CustomerAutoRegisteredByExternalMethodEvent>
    {
        #region Fields
        ...
        public AppleAuthenticationEventConsumer(ICustomerService customerService)
        {
        ...
        public async Task HandleEventAsync(CustomerAutoRegisteredByExternalMethodEvent eventMessage)
        {
            ...
            if (!eventMessage.AuthenticationParameters.ProviderSystemName.Equals(AppleAuthenticationDefaults.SystemName))
                return; 
