...
namespace MWT.Plugin.Misc.MwtStorefront.Infrastructure.Mapping
{
    public static class MappingExtensions
    {
        ...
        public static AddressExtendedModel CustomAddressModelToAddressExtendedModel(this CustomAddressModel model, bool trimFields = true)
        {
            if (model == null)
                return null;
            var destination = new AddressExtendedModel();
        ...
        public static CustomAddressModel AddressExtendedModelToCustomAddressModel(this AddressExtendedModel model, bool trimFields = true)
        {
            if (model == null)
                return null;
