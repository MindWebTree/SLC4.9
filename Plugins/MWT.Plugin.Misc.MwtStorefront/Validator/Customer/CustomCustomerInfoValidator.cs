...
namespace MWT.Plugin.Misc.MwtStorefront.Validators.Customer
{
    public partial class CustomCustomerInfoValidator : BaseNopValidator<CustomerInfoExtendedModel>
    {
        public CustomCustomerInfoValidator(ILocalizationService localizationService,
            ...
            CustomerSettings customerSettings)
        {
            ...
            {
                RuleFor(x => x.FullName).NotEmpty().WithMessageAwait(localizationService.GetResourceAsync("Account.Fields.FullName.Required"));
            }
