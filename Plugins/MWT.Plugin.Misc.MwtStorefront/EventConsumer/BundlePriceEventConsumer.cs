...
namespace MWT.Plugin.Misc.MwtStorefront.EventConsumer
{
...

    {
        ...
        public async Task HandleEventAsync(EntityInsertedEvent<BundleItem> eventMessage)
        {
            ...
            if (bundle != null)
                await _staticCacheManager.RemoveByPrefixAsync(CustomNopCatalogDefaults.BundleWidgetPrefixCacheKeyById, bundle.ProductId);
        }
        ...
        public async Task HandleEventAsync(EntityUpdatedEvent<BundleConfiguration> eventMessage)
        {
            ...
            await _staticCacheManager.RemoveByPrefixAsync(CustomNopCatalogDefaults.BundleWidgetPrefixCacheKeyById, eventMessage.Entity.Id);
        }
        ...
        private async Task ProcessEvent(int productId)
        {
            try
            {
                await _staticCacheManager.RemoveByPrefixAsync(CustomNopCatalogDefaults.BundleWidgetPrefixCacheKeyById, productId);
