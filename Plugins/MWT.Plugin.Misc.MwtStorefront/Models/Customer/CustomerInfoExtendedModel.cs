...
using static Nop.Web.Models.Customer.CustomerInfoModel;

namespace MWT.Plugin.Misc.MwtStorefront.Models.Customer
{
   
    public partial record CustomerInfoExtendedModel : BaseNopModel
    {
        public CustomerInfoExtendedModel()
        {
        ...
        public IList<CustomerInfoModel.AssociatedExternalAuthModel> AssociatedExternalAuthRecords { get; set; }
