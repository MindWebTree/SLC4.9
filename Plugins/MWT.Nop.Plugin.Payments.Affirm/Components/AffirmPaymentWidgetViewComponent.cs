...
{
    public class AffirmPaymentWidgetViewComponent : NopViewComponent
    {
        #region Fields
        ...
        private readonly AffirmCheckoutSettings _settings;
        ...
        public AffirmPaymentWidgetViewComponent(IPaymentPluginManager paymentPluginManager,
            IStoreContext storeContext,
            IWorkContext workContext,
            AffirmCheckoutSettings settings,
        ...
        public async Task<IViewComponentResult> InvokeAsync(string widgetZone, object additionalData)
        {
            ...
            if (!await _serviceManager.IsConfigured(_settings))
                return Content(string.Empty);
