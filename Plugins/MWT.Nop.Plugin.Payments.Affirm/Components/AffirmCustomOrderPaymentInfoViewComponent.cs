...
{
    public class AffirmCustomOrderPaymentInfoViewComponent : NopViewComponent
    {
        #region Fields
      ...
      //  private readonly CustomOrderServiceManager _serviceManager;
        ...
        public AffirmCustomOrderPaymentInfoViewComponent(ILocalizationService localizationService,
            INotificationService notificationService,
            IPaymentService paymentService,
            OrderSettings orderSettings,
           // CustomOrderServiceManager serviceManager,
        ...
        //    _paymentService.GenerateOrderGuid(paymentRequest);
           ...
           // model = await _serviceManager.CheckoutInit(paymentRequest.OrderGuid,additionalData);
