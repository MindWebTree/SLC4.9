...
namespace MWT.Nop.Plugin.Payments.Affirm.Services
{
    public partial class AffirmService : IAffirmService
    {
        ...
        public AffirmService(AffirmCheckoutSettings affirmSettings, IHttpClientFactory httpClientFactory, IRepository<AffirmLog> affirmLogRepository, IWebHelper webHelper, IWorkContext workContext,
