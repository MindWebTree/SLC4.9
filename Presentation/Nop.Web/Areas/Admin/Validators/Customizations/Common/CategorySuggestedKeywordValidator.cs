...
{
    public partial class CategorySuggestedKeywordValidator : BaseNopValidator<CategorySuggestedKeywordModel>
    {
        public CategorySuggestedKeywordValidator(ILocalizationService localizationService, INopDataProvider dataProvider)
        {
