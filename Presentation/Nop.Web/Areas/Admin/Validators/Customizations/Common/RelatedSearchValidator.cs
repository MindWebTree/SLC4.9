...
{
    public partial class RelatedSearchValidator : BaseNopValidator<RelatedSearchModel>
    {
        public RelatedSearchValidator(ILocalizationService localizationService, INopDataProvider dataProvider)
        {
