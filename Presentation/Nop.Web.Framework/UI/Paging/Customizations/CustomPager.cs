...
namespace MWT.Nop.Core.FrameWork
{
    /// <summary>
    /// Renders a pager component from an IPageableModel datasource.
    /// </summary>
    public partial class CustomPager : IHtmlContent
    {
        #region Properties
        ...
        private string _queryParamViewAll = "viewall";
        ...
        private string _viewAllCssClass = "viewall-page";

        private string _showPagesCssClass = "showpage-page";

        public int _defaultPageSize { get; set; }

        #endregion

        #region Ctor

        public CustomPager(IPageableModel model, ViewContext context, int defaultPageSize)
        {
            _model = model;
            ViewContext = context;
        ...
        public CustomPager QueryParam(string value)
        {
            _queryParam = value;
            return this;
        }
        public CustomPager QueryParamViewAll(string value)
        {
            _queryParamViewAll = value;
            return this;
        }
        /// <summary>
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager ShowTotalSummary(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager ShowPagerItems(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager ShowFirst(bool value)
        {
            _showFirst = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager ShowPrevious(bool value)
        {
            _showPrevious = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager ShowNext(bool value)
        {
            _showNext = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager ShowLast(bool value)
        {
            _showLast = value;
            return this;
        }
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager ShowIndividualPages(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager RenderEmptyParameters(bool value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager IndividualPagesDisplayedCount(int value)
        {
        ...
        /// <returns>Pager</returns>
        public CustomPager BooleanParameterName(string paramName)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager FirstPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager PreviousPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager CurrentPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager IndividualPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager NextPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager LastPageCssClass(string value)
        {
        ...
        /// <param name="value">Value</param>
        /// <returns>Pager</returns>
        public CustomPager MainUlCssClass(string value)
        {
        ...
        protected virtual async Task<string> GenerateHtmlStringAsync()
        {
            ...
            if (_showPagerItems && _model.TotalPages > 1)
            {
                ...
                links.Append(await CreatePageLinkAsync(-1, await localizationService.GetResourceAsync("Pager.ViewAll"), _viewAllCssClass));

                // end
            }
            else
            {
                if (_model.TotalItems > (_defaultPageSize == 0 ? 30 : _defaultPageSize))
                {
                    links.Append(await CreatePageLinkAsync(-2, await localizationService.GetResourceAsync("Pager.Showage"), _showPagesCssClass));
                }
            }
		...
		protected virtual async Task<string> CreatePageLinkAsync(int pageNumber, string text, string cssClass)
        {
            ...
            if (cssClass == _firstPageCssClass)
                ariaLabelText = "Go to first page";
            else if (cssClass == _previousPageCssClass)
                ariaLabelText = "Go to previous page";
            else if (cssClass == _nextPageCssClass)
                ariaLabelText = "Go to next page";
            else if (cssClass == _lastPageCssClass)
                ariaLabelText = "Go to last page";
            else if (cssClass == _viewAllCssClass)
                ariaLabelText = "View all products on one page";
            else if (cssClass == _showPagesCssClass)
                ariaLabelText = "Return to paged product grid view";
            else
                ariaLabelText = $"Go to page {text}";
            aBuilder.MergeAttribute("aria-label", ariaLabelText);
        ...
        protected virtual string CreateDefaultUrl(int pageNumber)
        {
            ...
            if (pageNumber > 1)
            {
                ...
                if (routeValues.ContainsKey(_queryParamViewAll))
                    routeValues.Remove(_queryParamViewAll);
            }
            else
            {
            ...
            #region ViewAllUpdates

            if (pageNumber == -1)
                routeValues[_queryParamViewAll] = 1;


            if (pageNumber == -2)
                routeValues[_queryParamViewAll] = 0;
