...
namespace MWT.Nop.Core.Service.Catalog
{
    ...
    public partial class ProductExtendedService : ProductService, IProductExtendedService
    {
        #region Fields
