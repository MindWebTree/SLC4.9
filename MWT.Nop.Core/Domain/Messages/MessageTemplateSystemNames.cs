...
namespace MWT.Nop.Core.Domain.Messages
{
    public static partial class MessageTemplateExtendedSystemNames
    {
        ...
        public const string SupportPendingOrderMessage = "SupportPendingOrder.MessageTemplate";
        #endregion
    }
}
